...
export const getDashboardStats = asyncHandler(async (req, res) => {
    ...
    const extractCount = (bucket) => bucket[0]?.count ?? 0;
    ...
    const totalProjectsPrevious = extractCount(projectStats[0].totalProjectsPrevious);
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, dashboardStats, "Successfully fetch dashboard stats"));
});
...
export const getWelcomeSummary = asyncHandler(async (req, res) => {
    const startOfToday = new Date();
    startOfToday.setHours(0, 0, 0, 0);
    const endOfToday = new Date();
    endOfToday.setHours(23, 59, 59, 999);
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, welcomeSummary, "Successfully fetch welcome summary"));
});
export const getAllProjects = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, projects || [], "Successfully fetched all projects for dashboard"));
});
